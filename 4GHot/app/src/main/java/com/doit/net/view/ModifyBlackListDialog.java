...
public class ModifyBlackListDialog extends Dialog {
    ...
    public ModifyBlackListDialog(Context context, String imsi, String msisdn, String remark) {
    ...
    public ModifyBlackListDialog(Context context, String imsi, String msisdn, String remark, boolean editable) {
        super(context, R.style.Theme_dialog);
        modifyIMSI = imsi;
        modifyMsisdn = msisdn;
        modifyRemark = remark;
